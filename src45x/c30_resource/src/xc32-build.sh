...
(cd xc32; ../generator/rg -DMCHP_VERSION=${VERSION_ID} -DMCHP_RESOURCE=${MCHP_RESOURCE:-$CMD_RVERSION} xc32_devices.res xc32_device.info .LanguageToolSuite deviceSupport.xml)
