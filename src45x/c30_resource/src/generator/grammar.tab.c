...
#line 168 "grammar.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "resource_data_item", "resource_data", YY_NULL
};
#endif
...
#line 50 "grammar.y" /* yacc.c:1646  */
    {
              ...
              } else rib.tool_chain = (yyvsp[0].sval);
            }
...
#line 56 "grammar.y" /* yacc.c:1646  */
    {
                if (rib.version.major | rib.version.minor) {
                  ...
                  rib.version.major = (yyvsp[0].version).major;
                  rib.version.minor = (yyvsp[0].version).minor;
                }
              }
#line 1282 "grammar.tab.c" /* yacc.c:1646  */
    break;
...
#line 65 "grammar.y" /* yacc.c:1646  */
    {
                    if (rib.resource_version_increment) {
                      ...
                      rib.resource_version_increment = (yyvsp[0].cval);
                    }
                  }
#line 1294 "grammar.tab.c" /* yacc.c:1646  */
    break;
...
#line 72 "grammar.y" /* yacc.c:1646  */
    {
                    if (rib.resource_version_increment) {
                      ...
                      rib.resource_version_increment = (yyvsp[0].ival);
                    }
                  }
...
#line 90 "grammar.y" /* yacc.c:1646  */
    {
                      if (rib.field_sizes == 0) {
                        ...
                        field_no++;
                        rib.field_sizes[rib.field_count - field_no] = (yyvsp[0].ival);
                      }
                    }
...
#line 98 "grammar.y" /* yacc.c:1646  */
    {
                      if (rib.field_sizes == 0) {
                        ...
                        if (field_no > rib.field_count) {
                          ...
                          rib.field_sizes[rib.field_count - field_no] = (yyvsp[-2].ival);
                        }
                      }
                    }
...
#line 152 "grammar.y" /* yacc.c:1646  */
    {
             d = malloc(sizeof(struct resource_data));
             d->kind = rik_version;
             d->v.version.major = (yyvsp[0].version).major;
             d->v.version.minor = (yyvsp[0].version).minor;
             (yyval.data) = d;
           }
...
#line 167 "grammar.y" /* yacc.c:1646  */
    {
           ...
           if (field_no >= rib.field_count) {
             ...
             if (resource_data_size((yyvsp[0].data)) > rib.field_sizes[field_no]) {
               error("Data item is too large for field!");
             }
             current_record->fields[field_no++] = (yyvsp[0].data);
           }
         }
...
#line 1535 "grammar.tab.c" /* yacc.c:1646  */
      default: break;
    }
