...
(define_constants
  [(UNSPEC_LOAD_LOW		 0)
   ...
   (UNSPEC_COMPARE_AND_SWAP_ACQ	602)
   (UNSPEC_COMPARE_AND_SWAP_REL	603)
   (UNSPEC_SWAP_ACQ		604)
   (UNSPEC_SWAP_REL		605)
   ...
   (UNSPECV_SOFTWARE_BREAKPOINT    820)
  ...
  "!TARGET_MIPS16 && and_operands_ok (<MODE>mode, operands[1], operands[2])"
{
  ...
  [(set_attr "move_type" "load,load,load,andi,ext_ins,shift_shift,logical")
   (set_attr "alu_type" "unknown,unknown,unknown,and,unknown,unknown,and")
  ...
  "TARGET_MIPS16 && and_operands_ok (<MODE>mode, operands[1], operands[2])"
{
  ...
  [(set_attr "move_type" "load,load,load,shift_shift,logical")
   (set_attr "alu_type" "unknown,unknown,unknown,unknown,and")
   (set_attr "mode" "<MODE>")])
...
(define_insn "pic32_switch_isabase"
  ...
  ""
  {
   ...
   if (TARGET_MIPS16)
   {
     ...
     return pic32_output_switch_ISAbase();
   }
   else
   {
