...
#if 0 /* Moved to mips-machine-function.h */
...
static const struct mips_cpu_info mips_cpu_info_table[] =
{
  ...
  /* Microchip PIC32MX MCUs based on M4K core. */
  { "pic32mx", PROCESSOR_M4K, 33, 0 },
};
...
#ifdef MIPS_SUBTARGET_FUNCTION_OK_FOR_SIBCALL
  if (false == MIPS_SUBTARGET_FUNCTION_OK_FOR_SIBCALL())
    {
      return false;
    }
#endif
  ...
  if (cfun->machine->interrupt_handler_p)
    {
      ...
      /* For PIC32, always save EPC for caching purposes. */
#if !defined(TARGET_MCHP_PIC32MX)
...
mips_for_each_saved_acc (HOST_WIDE_INT sp_offset, mips_save_restore_fn fn)
{
  ...
  if (BITSET_P (cfun->machine->frame.acc_mask, 0))
    {
      /* The accumulators HI/LO should be saved as late as possible in
         an ISR. Do not let them move up when optimizations are enabled. */
      if (cfun->machine->interrupt_handler_p)
        {
          emit_insn (gen_blockage ());
        }
...
void mips_save_reg (rtx reg, rtx mem);
...
static const struct mips_builtin_description mips_builtins[] = {
  ...
  PIC32_EXPAND_BUILTIN (software_breakpoint, PIC32_BUILTIN_SOFTWARE_BREAKPOINT, MIPS_VOID_FTYPE_VOID)
};

enum mips_builtinnums
{
  MIPS_BUILTIN_NUMS_pll_ps,
  MIPS_BUILTIN_NUMS_pul_ps,
  MIPS_BUILTIN_NUMS_plu_ps,
  MIPS_BUILTIN_NUMS_puu_ps,
  MIPS_BUILTIN_NUMS_cvt_ps_s,
  MIPS_BUILTIN_NUMS_cvt_s_pl,
  MIPS_BUILTIN_NUMS_cvt_s_pu,
  MIPS_BUILTIN_NUMS_abs_ps,
  MIPS_BUILTIN_NUMS_alnv_ps,
  MIPS_BUILTIN_NUMS_addr_ps,
  MIPS_BUILTIN_NUMS_mulr_ps,
  MIPS_BUILTIN_NUMS_cvt_pw_ps,
  MIPS_BUILTIN_NUMS_cvt_ps_pw,
  MIPS_BUILTIN_NUMS_recip1_s,
  MIPS_BUILTIN_NUMS_recip1_d,
  MIPS_BUILTIN_NUMS_recip1_ps,
  MIPS_BUILTIN_NUMS_recip2_s,
  MIPS_BUILTIN_NUMS_recip2_d,
  MIPS_BUILTIN_NUMS_recip2_ps,
  MIPS_BUILTIN_NUMS_rsqrt1_s,
  MIPS_BUILTIN_NUMS_rsqrt1_d,
  MIPS_BUILTIN_NUMS_rsqrt1_ps,
  MIPS_BUILTIN_NUMS_rsqrt2_s,
  MIPS_BUILTIN_NUMS_rsqrt2_d,
  MIPS_BUILTIN_NUMS_rsqrt2_ps,
  MIPS_BUILTIN_NUMS_movt_c_f_ps,
  MIPS_BUILTIN_NUMS_movf_c_f_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_f_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_f_ps,
  MIPS_BUILTIN_NUMS_cabs_f_s,
  MIPS_BUILTIN_NUMS_cabs_f_d,
  MIPS_BUILTIN_NUMS_any_c_f_ps,
  MIPS_BUILTIN_NUMS_all_c_f_ps,
  MIPS_BUILTIN_NUMS_lower_c_f_ps,
  MIPS_BUILTIN_NUMS_upper_c_f_ps,
  MIPS_BUILTIN_NUMS_any_cabs_f_ps,
  MIPS_BUILTIN_NUMS_all_cabs_f_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_f_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_f_ps,
  MIPS_BUILTIN_NUMS_any_c_f_4s,
  MIPS_BUILTIN_NUMS_all_c_f_4s,
  MIPS_BUILTIN_NUMS_any_cabs_f_4s,
  MIPS_BUILTIN_NUMS_all_cabs_f_4s,
  MIPS_BUILTIN_NUMS_movt_c_un_ps,
  MIPS_BUILTIN_NUMS_movf_c_un_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_un_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_un_ps,
  MIPS_BUILTIN_NUMS_cabs_un_s,
  MIPS_BUILTIN_NUMS_cabs_un_d,
  MIPS_BUILTIN_NUMS_any_c_un_ps,
  MIPS_BUILTIN_NUMS_all_c_un_ps,
  MIPS_BUILTIN_NUMS_lower_c_un_ps,
  MIPS_BUILTIN_NUMS_upper_c_un_ps,
  MIPS_BUILTIN_NUMS_any_cabs_un_ps,
  MIPS_BUILTIN_NUMS_all_cabs_un_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_un_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_un_ps,
  MIPS_BUILTIN_NUMS_any_c_un_4s,
  MIPS_BUILTIN_NUMS_all_c_un_4s,
  MIPS_BUILTIN_NUMS_any_cabs_un_4s,
  MIPS_BUILTIN_NUMS_all_cabs_un_4s,
  MIPS_BUILTIN_NUMS_movt_c_eq_ps,
  MIPS_BUILTIN_NUMS_movf_c_eq_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_cabs_eq_s,
  MIPS_BUILTIN_NUMS_cabs_eq_d,
  MIPS_BUILTIN_NUMS_any_c_eq_ps,
  MIPS_BUILTIN_NUMS_all_c_eq_ps,
  MIPS_BUILTIN_NUMS_lower_c_eq_ps,
  MIPS_BUILTIN_NUMS_upper_c_eq_ps,
  MIPS_BUILTIN_NUMS_any_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_all_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_eq_ps,
  MIPS_BUILTIN_NUMS_any_c_eq_4s,
  MIPS_BUILTIN_NUMS_all_c_eq_4s,
  MIPS_BUILTIN_NUMS_any_cabs_eq_4s,
  MIPS_BUILTIN_NUMS_all_cabs_eq_4s,
  MIPS_BUILTIN_NUMS_movt_c_ueq_ps,
  MIPS_BUILTIN_NUMS_movf_c_ueq_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_cabs_ueq_s,
  MIPS_BUILTIN_NUMS_cabs_ueq_d,
  MIPS_BUILTIN_NUMS_any_c_ueq_ps,
  MIPS_BUILTIN_NUMS_all_c_ueq_ps,
  MIPS_BUILTIN_NUMS_lower_c_ueq_ps,
  MIPS_BUILTIN_NUMS_upper_c_ueq_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ueq_ps,
  MIPS_BUILTIN_NUMS_any_c_ueq_4s,
  MIPS_BUILTIN_NUMS_all_c_ueq_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ueq_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ueq_4s,
  MIPS_BUILTIN_NUMS_movt_c_olt_ps,
  MIPS_BUILTIN_NUMS_movf_c_olt_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_cabs_olt_s,
  MIPS_BUILTIN_NUMS_cabs_olt_d,
  MIPS_BUILTIN_NUMS_any_c_olt_ps,
  MIPS_BUILTIN_NUMS_all_c_olt_ps,
  MIPS_BUILTIN_NUMS_lower_c_olt_ps,
  MIPS_BUILTIN_NUMS_upper_c_olt_ps,
  MIPS_BUILTIN_NUMS_any_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_all_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_olt_ps,
  MIPS_BUILTIN_NUMS_any_c_olt_4s,
  MIPS_BUILTIN_NUMS_all_c_olt_4s,
  MIPS_BUILTIN_NUMS_any_cabs_olt_4s,
  MIPS_BUILTIN_NUMS_all_cabs_olt_4s,
  MIPS_BUILTIN_NUMS_movt_c_ult_ps,
  MIPS_BUILTIN_NUMS_movf_c_ult_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_cabs_ult_s,
  MIPS_BUILTIN_NUMS_cabs_ult_d,
  MIPS_BUILTIN_NUMS_any_c_ult_ps,
  MIPS_BUILTIN_NUMS_all_c_ult_ps,
  MIPS_BUILTIN_NUMS_lower_c_ult_ps,
  MIPS_BUILTIN_NUMS_upper_c_ult_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ult_ps,
  MIPS_BUILTIN_NUMS_any_c_ult_4s,
  MIPS_BUILTIN_NUMS_all_c_ult_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ult_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ult_4s,
  MIPS_BUILTIN_NUMS_movt_c_ole_ps,
  MIPS_BUILTIN_NUMS_movf_c_ole_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_cabs_ole_s,
  MIPS_BUILTIN_NUMS_cabs_ole_d,
  MIPS_BUILTIN_NUMS_any_c_ole_ps,
  MIPS_BUILTIN_NUMS_all_c_ole_ps,
  MIPS_BUILTIN_NUMS_lower_c_ole_ps,
  MIPS_BUILTIN_NUMS_upper_c_ole_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ole_ps,
  MIPS_BUILTIN_NUMS_any_c_ole_4s,
  MIPS_BUILTIN_NUMS_all_c_ole_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ole_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ole_4s,
  MIPS_BUILTIN_NUMS_movt_c_ule_ps,
  MIPS_BUILTIN_NUMS_movf_c_ule_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_cabs_ule_s,
  MIPS_BUILTIN_NUMS_cabs_ule_d,
  MIPS_BUILTIN_NUMS_any_c_ule_ps,
  MIPS_BUILTIN_NUMS_all_c_ule_ps,
  MIPS_BUILTIN_NUMS_lower_c_ule_ps,
  MIPS_BUILTIN_NUMS_upper_c_ule_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ule_ps,
  MIPS_BUILTIN_NUMS_any_c_ule_4s,
  MIPS_BUILTIN_NUMS_all_c_ule_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ule_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ule_4s,
  MIPS_BUILTIN_NUMS_movt_c_sf_ps,
  MIPS_BUILTIN_NUMS_movf_c_sf_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_cabs_sf_s,
  MIPS_BUILTIN_NUMS_cabs_sf_d,
  MIPS_BUILTIN_NUMS_any_c_sf_ps,
  MIPS_BUILTIN_NUMS_all_c_sf_ps,
  MIPS_BUILTIN_NUMS_lower_c_sf_ps,
  MIPS_BUILTIN_NUMS_upper_c_sf_ps,
  MIPS_BUILTIN_NUMS_any_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_all_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_sf_ps,
  MIPS_BUILTIN_NUMS_any_c_sf_4s,
  MIPS_BUILTIN_NUMS_all_c_sf_4s,
  MIPS_BUILTIN_NUMS_any_cabs_sf_4s,
  MIPS_BUILTIN_NUMS_all_cabs_sf_4s,
  MIPS_BUILTIN_NUMS_movt_c_ngle_ps,
  MIPS_BUILTIN_NUMS_movf_c_ngle_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_cabs_ngle_s,
  MIPS_BUILTIN_NUMS_cabs_ngle_d,
  MIPS_BUILTIN_NUMS_any_c_ngle_ps,
  MIPS_BUILTIN_NUMS_all_c_ngle_ps,
  MIPS_BUILTIN_NUMS_lower_c_ngle_ps,
  MIPS_BUILTIN_NUMS_upper_c_ngle_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ngle_ps,
  MIPS_BUILTIN_NUMS_any_c_ngle_4s,
  MIPS_BUILTIN_NUMS_all_c_ngle_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ngle_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ngle_4s,
  MIPS_BUILTIN_NUMS_movt_c_seq_ps,
  MIPS_BUILTIN_NUMS_movf_c_seq_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_cabs_seq_s,
  MIPS_BUILTIN_NUMS_cabs_seq_d,
  MIPS_BUILTIN_NUMS_any_c_seq_ps,
  MIPS_BUILTIN_NUMS_all_c_seq_ps,
  MIPS_BUILTIN_NUMS_lower_c_seq_ps,
  MIPS_BUILTIN_NUMS_upper_c_seq_ps,
  MIPS_BUILTIN_NUMS_any_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_all_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_seq_ps,
  MIPS_BUILTIN_NUMS_any_c_seq_4s,
  MIPS_BUILTIN_NUMS_all_c_seq_4s,
  MIPS_BUILTIN_NUMS_any_cabs_seq_4s,
  MIPS_BUILTIN_NUMS_all_cabs_seq_4s,
  MIPS_BUILTIN_NUMS_movt_c_ngl_ps,
  MIPS_BUILTIN_NUMS_movf_c_ngl_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_cabs_ngl_s,
  MIPS_BUILTIN_NUMS_cabs_ngl_d,
  MIPS_BUILTIN_NUMS_any_c_ngl_ps,
  MIPS_BUILTIN_NUMS_all_c_ngl_ps,
  MIPS_BUILTIN_NUMS_lower_c_ngl_ps,
  MIPS_BUILTIN_NUMS_upper_c_ngl_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ngl_ps,
  MIPS_BUILTIN_NUMS_any_c_ngl_4s,
  MIPS_BUILTIN_NUMS_all_c_ngl_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ngl_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ngl_4s,
  MIPS_BUILTIN_NUMS_movt_c_lt_ps,
  MIPS_BUILTIN_NUMS_movf_c_lt_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_cabs_lt_s,
  MIPS_BUILTIN_NUMS_cabs_lt_d,
  MIPS_BUILTIN_NUMS_any_c_lt_ps,
  MIPS_BUILTIN_NUMS_all_c_lt_ps,
  MIPS_BUILTIN_NUMS_lower_c_lt_ps,
  MIPS_BUILTIN_NUMS_upper_c_lt_ps,
  MIPS_BUILTIN_NUMS_any_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_all_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_lt_ps,
  MIPS_BUILTIN_NUMS_any_c_lt_4s,
  MIPS_BUILTIN_NUMS_all_c_lt_4s,
  MIPS_BUILTIN_NUMS_any_cabs_lt_4s,
  MIPS_BUILTIN_NUMS_all_cabs_lt_4s,
  MIPS_BUILTIN_NUMS_movt_c_nge_ps,
  MIPS_BUILTIN_NUMS_movf_c_nge_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_cabs_nge_s,
  MIPS_BUILTIN_NUMS_cabs_nge_d,
  MIPS_BUILTIN_NUMS_any_c_nge_ps,
  MIPS_BUILTIN_NUMS_all_c_nge_ps,
  MIPS_BUILTIN_NUMS_lower_c_nge_ps,
  MIPS_BUILTIN_NUMS_upper_c_nge_ps,
  MIPS_BUILTIN_NUMS_any_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_all_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_nge_ps,
  MIPS_BUILTIN_NUMS_any_c_nge_4s,
  MIPS_BUILTIN_NUMS_all_c_nge_4s,
  MIPS_BUILTIN_NUMS_any_cabs_nge_4s,
  MIPS_BUILTIN_NUMS_all_cabs_nge_4s,
  MIPS_BUILTIN_NUMS_movt_c_le_ps,
  MIPS_BUILTIN_NUMS_movf_c_le_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_le_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_le_ps,
  MIPS_BUILTIN_NUMS_cabs_le_s,
  MIPS_BUILTIN_NUMS_cabs_le_d,
  MIPS_BUILTIN_NUMS_any_c_le_ps,
  MIPS_BUILTIN_NUMS_all_c_le_ps,
  MIPS_BUILTIN_NUMS_lower_c_le_ps,
  MIPS_BUILTIN_NUMS_upper_c_le_ps,
  MIPS_BUILTIN_NUMS_any_cabs_le_ps,
  MIPS_BUILTIN_NUMS_all_cabs_le_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_le_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_le_ps,
  MIPS_BUILTIN_NUMS_any_c_le_4s,
  MIPS_BUILTIN_NUMS_all_c_le_4s,
  MIPS_BUILTIN_NUMS_any_cabs_le_4s,
  MIPS_BUILTIN_NUMS_all_cabs_le_4s,
  MIPS_BUILTIN_NUMS_movt_c_ngt_ps,
  MIPS_BUILTIN_NUMS_movf_c_ngt_ps,
  MIPS_BUILTIN_NUMS_movt_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_movf_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_cabs_ngt_s,
  MIPS_BUILTIN_NUMS_cabs_ngt_d,
  MIPS_BUILTIN_NUMS_any_c_ngt_ps,
  MIPS_BUILTIN_NUMS_all_c_ngt_ps,
  MIPS_BUILTIN_NUMS_lower_c_ngt_ps,
  MIPS_BUILTIN_NUMS_upper_c_ngt_ps,
  MIPS_BUILTIN_NUMS_any_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_all_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_lower_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_upper_cabs_ngt_ps,
  MIPS_BUILTIN_NUMS_any_c_ngt_4s,
  MIPS_BUILTIN_NUMS_all_c_ngt_4s,
  MIPS_BUILTIN_NUMS_any_cabs_ngt_4s,
  MIPS_BUILTIN_NUMS_all_cabs_ngt_4s,
  MIPS_BUILTIN_NUMS_sqrt_ps,
  MIPS_BUILTIN_NUMS_addq_ph,
  MIPS_BUILTIN_NUMS_addq_s_ph,
  MIPS_BUILTIN_NUMS_addq_s_w,
  MIPS_BUILTIN_NUMS_addu_qb,
  MIPS_BUILTIN_NUMS_addu_s_qb,
  MIPS_BUILTIN_NUMS_subq_ph,
  MIPS_BUILTIN_NUMS_subq_s_ph,
  MIPS_BUILTIN_NUMS_subq_s_w,
  MIPS_BUILTIN_NUMS_subu_qb,
  MIPS_BUILTIN_NUMS_subu_s_qb,
  MIPS_BUILTIN_NUMS_addsc,
  MIPS_BUILTIN_NUMS_addwc,
  MIPS_BUILTIN_NUMS_modsub,
  MIPS_BUILTIN_NUMS_raddu_w_qb,
  MIPS_BUILTIN_NUMS_absq_s_ph,
  MIPS_BUILTIN_NUMS_absq_s_w,
  MIPS_BUILTIN_NUMS_precrq_qb_ph,
  MIPS_BUILTIN_NUMS_precrq_ph_w,
  MIPS_BUILTIN_NUMS_precrq_rs_ph_w,
  MIPS_BUILTIN_NUMS_precrqu_s_qb_ph,
  MIPS_BUILTIN_NUMS_preceq_w_phl,
  MIPS_BUILTIN_NUMS_preceq_w_phr,
  MIPS_BUILTIN_NUMS_precequ_ph_qbl,
  MIPS_BUILTIN_NUMS_precequ_ph_qbr,
  MIPS_BUILTIN_NUMS_precequ_ph_qbla,
  MIPS_BUILTIN_NUMS_precequ_ph_qbra,
  MIPS_BUILTIN_NUMS_preceu_ph_qbl,
  MIPS_BUILTIN_NUMS_preceu_ph_qbr,
  MIPS_BUILTIN_NUMS_preceu_ph_qbla,
  MIPS_BUILTIN_NUMS_preceu_ph_qbra,
  MIPS_BUILTIN_NUMS_shll_qb,
  MIPS_BUILTIN_NUMS_shll_ph,
  MIPS_BUILTIN_NUMS_shll_s_ph,
  MIPS_BUILTIN_NUMS_shll_s_w,
  MIPS_BUILTIN_NUMS_shrl_qb,
  MIPS_BUILTIN_NUMS_shra_ph,
  MIPS_BUILTIN_NUMS_shra_r_ph,
  MIPS_BUILTIN_NUMS_shra_r_w,
  MIPS_BUILTIN_NUMS_muleu_s_ph_qbl,
  MIPS_BUILTIN_NUMS_muleu_s_ph_qbr,
  MIPS_BUILTIN_NUMS_mulq_rs_ph,
  MIPS_BUILTIN_NUMS_muleq_s_w_phl,
  MIPS_BUILTIN_NUMS_muleq_s_w_phr,
  MIPS_BUILTIN_NUMS_bitrev,
  MIPS_BUILTIN_NUMS_insv,
  MIPS_BUILTIN_NUMS_repl_qb,
  MIPS_BUILTIN_NUMS_repl_ph,
  MIPS_BUILTIN_NUMS_cmpu_eq_qb,
  MIPS_BUILTIN_NUMS_cmpu_lt_qb,
  MIPS_BUILTIN_NUMS_cmpu_le_qb,
  MIPS_BUILTIN_NUMS_cmpgu_eq_qb,
  MIPS_BUILTIN_NUMS_cmpgu_lt_qb,
  MIPS_BUILTIN_NUMS_cmpgu_le_qb,
  MIPS_BUILTIN_NUMS_cmp_eq_ph,
  MIPS_BUILTIN_NUMS_cmp_lt_ph,
  MIPS_BUILTIN_NUMS_cmp_le_ph,
  MIPS_BUILTIN_NUMS_pick_qb,
  MIPS_BUILTIN_NUMS_pick_ph,
  MIPS_BUILTIN_NUMS_packrl_ph,
  MIPS_BUILTIN_NUMS_wrdsp,
  MIPS_BUILTIN_NUMS_rddsp,
  MIPS_BUILTIN_NUMS_lbux,
  MIPS_BUILTIN_NUMS_lhx,
  MIPS_BUILTIN_NUMS_lwx,
  MIPS_BUILTIN_NUMS_bposge32,
  MIPS_BUILTIN_NUMS_absq_s_qb,
  MIPS_BUILTIN_NUMS_addu_ph,
  MIPS_BUILTIN_NUMS_addu_s_ph,
  MIPS_BUILTIN_NUMS_adduh_qb,
  MIPS_BUILTIN_NUMS_adduh_r_qb,
  MIPS_BUILTIN_NUMS_append,
  MIPS_BUILTIN_NUMS_balign,
  MIPS_BUILTIN_NUMS_cmpgdu_eq_qb,
  MIPS_BUILTIN_NUMS_cmpgdu_lt_qb,
  MIPS_BUILTIN_NUMS_cmpgdu_le_qb,
  MIPS_BUILTIN_NUMS_mul_ph,
  MIPS_BUILTIN_NUMS_mul_s_ph,
  MIPS_BUILTIN_NUMS_mulq_rs_w,
  MIPS_BUILTIN_NUMS_mulq_s_ph,
  MIPS_BUILTIN_NUMS_mulq_s_w,
  MIPS_BUILTIN_NUMS_precr_qb_ph,
  MIPS_BUILTIN_NUMS_precr_sra_ph_w,
  MIPS_BUILTIN_NUMS_precr_sra_r_ph_w,
  MIPS_BUILTIN_NUMS_prepend,
  MIPS_BUILTIN_NUMS_shra_qb,
  MIPS_BUILTIN_NUMS_shra_r_qb,
  MIPS_BUILTIN_NUMS_shrl_ph,
  MIPS_BUILTIN_NUMS_subu_ph,
  MIPS_BUILTIN_NUMS_subu_s_ph,
  MIPS_BUILTIN_NUMS_subuh_qb,
  MIPS_BUILTIN_NUMS_subuh_r_qb,
  MIPS_BUILTIN_NUMS_addqh_ph,
  MIPS_BUILTIN_NUMS_addqh_r_ph,
  MIPS_BUILTIN_NUMS_addqh_w,
  MIPS_BUILTIN_NUMS_addqh_r_w,
  MIPS_BUILTIN_NUMS_subqh_ph,
  MIPS_BUILTIN_NUMS_subqh_r_ph,
  MIPS_BUILTIN_NUMS_subqh_w,
  MIPS_BUILTIN_NUMS_subqh_r_w,
  MIPS_BUILTIN_NUMS_dpau_h_qbl,
  MIPS_BUILTIN_NUMS_dpau_h_qbr,
  MIPS_BUILTIN_NUMS_dpsu_h_qbl,
  MIPS_BUILTIN_NUMS_dpsu_h_qbr,
  MIPS_BUILTIN_NUMS_dpaq_s_w_ph,
  MIPS_BUILTIN_NUMS_dpsq_s_w_ph,
  MIPS_BUILTIN_NUMS_mulsaq_s_w_ph,
  MIPS_BUILTIN_NUMS_dpaq_sa_l_w,
  MIPS_BUILTIN_NUMS_dpsq_sa_l_w,
  MIPS_BUILTIN_NUMS_maq_s_w_phl,
  MIPS_BUILTIN_NUMS_maq_s_w_phr,
  MIPS_BUILTIN_NUMS_maq_sa_w_phl,
  MIPS_BUILTIN_NUMS_maq_sa_w_phr,
  MIPS_BUILTIN_NUMS_extr_w,
  MIPS_BUILTIN_NUMS_extr_r_w,
  MIPS_BUILTIN_NUMS_extr_rs_w,
  MIPS_BUILTIN_NUMS_extr_s_h,
  MIPS_BUILTIN_NUMS_extp,
  MIPS_BUILTIN_NUMS_extpdp,
  MIPS_BUILTIN_NUMS_shilo,
  MIPS_BUILTIN_NUMS_mthlip,
  MIPS_BUILTIN_NUMS_dpa_w_ph,
  MIPS_BUILTIN_NUMS_dps_w_ph,
  MIPS_BUILTIN_NUMS_madd,
  MIPS_BUILTIN_NUMS_maddu,
  MIPS_BUILTIN_NUMS_msub,
  MIPS_BUILTIN_NUMS_msubu,
  MIPS_BUILTIN_NUMS_mulsa_w_ph,
  MIPS_BUILTIN_NUMS_mult,
  MIPS_BUILTIN_NUMS_multu,
  MIPS_BUILTIN_NUMS_dpax_w_ph,
  MIPS_BUILTIN_NUMS_dpsx_w_ph,
  MIPS_BUILTIN_NUMS_dpaqx_s_w_ph,
  MIPS_BUILTIN_NUMS_dpaqx_sa_w_ph,
  MIPS_BUILTIN_NUMS_dpsqx_s_w_ph,
  MIPS_BUILTIN_NUMS_dpsqx_sa_w_ph,
  MIPS_BUILTIN_NUMS_packsswh,
  MIPS_BUILTIN_NUMS_packsshb,
  MIPS_BUILTIN_NUMS_packushb,
  MIPS_BUILTIN_NUMS_paddw_u,
  MIPS_BUILTIN_NUMS_paddh_u,
  MIPS_BUILTIN_NUMS_paddb_u,
  MIPS_BUILTIN_NUMS_paddw_s,
  MIPS_BUILTIN_NUMS_paddh_s,
  MIPS_BUILTIN_NUMS_paddb_s,
  MIPS_BUILTIN_NUMS_paddd_u,
  MIPS_BUILTIN_NUMS_paddd_s,
  MIPS_BUILTIN_NUMS_paddsh,
  MIPS_BUILTIN_NUMS_paddsb,
  MIPS_BUILTIN_NUMS_paddush,
  MIPS_BUILTIN_NUMS_paddusb,
  MIPS_BUILTIN_NUMS_pandn_ud,
  MIPS_BUILTIN_NUMS_pandn_uw,
  MIPS_BUILTIN_NUMS_pandn_uh,
  MIPS_BUILTIN_NUMS_pandn_ub,
  MIPS_BUILTIN_NUMS_pandn_sd,
  MIPS_BUILTIN_NUMS_pandn_sw,
  MIPS_BUILTIN_NUMS_pandn_sh,
  MIPS_BUILTIN_NUMS_pandn_sb,
  MIPS_BUILTIN_NUMS_pavgh,
  MIPS_BUILTIN_NUMS_pavgb,
  MIPS_BUILTIN_NUMS_pcmpeqw_u,
  MIPS_BUILTIN_NUMS_pcmpeqh_u,
  MIPS_BUILTIN_NUMS_pcmpeqb_u,
  MIPS_BUILTIN_NUMS_pcmpeqw_s,
  MIPS_BUILTIN_NUMS_pcmpeqh_s,
  MIPS_BUILTIN_NUMS_pcmpeqb_s,
  MIPS_BUILTIN_NUMS_pcmpgtw_u,
  MIPS_BUILTIN_NUMS_pcmpgth_u,
  MIPS_BUILTIN_NUMS_pcmpgtb_u,
  MIPS_BUILTIN_NUMS_pcmpgtw_s,
  MIPS_BUILTIN_NUMS_pcmpgth_s,
  MIPS_BUILTIN_NUMS_pcmpgtb_s,
  MIPS_BUILTIN_NUMS_pextrh_u,
  MIPS_BUILTIN_NUMS_pextrh_s,
  MIPS_BUILTIN_NUMS_pinsrh_0_u,
  MIPS_BUILTIN_NUMS_pinsrh_1_u,
  MIPS_BUILTIN_NUMS_pinsrh_2_u,
  MIPS_BUILTIN_NUMS_pinsrh_3_u,
  MIPS_BUILTIN_NUMS_pinsrh_0_s,
  MIPS_BUILTIN_NUMS_pinsrh_1_s,
  MIPS_BUILTIN_NUMS_pinsrh_2_s,
  MIPS_BUILTIN_NUMS_pinsrh_3_s,
  MIPS_BUILTIN_NUMS_pmaddhw,
  MIPS_BUILTIN_NUMS_pmaxsh,
  MIPS_BUILTIN_NUMS_pmaxub,
  MIPS_BUILTIN_NUMS_pminsh,
  MIPS_BUILTIN_NUMS_pminub,
  MIPS_BUILTIN_NUMS_pmovmskb_u,
  MIPS_BUILTIN_NUMS_pmovmskb_s,
  MIPS_BUILTIN_NUMS_pmulhuh,
  MIPS_BUILTIN_NUMS_pmulhh,
  MIPS_BUILTIN_NUMS_pmullh,
  MIPS_BUILTIN_NUMS_pmuluw,
  MIPS_BUILTIN_NUMS_pasubub,
  MIPS_BUILTIN_NUMS_biadd,
  MIPS_BUILTIN_NUMS_psadbh,
  MIPS_BUILTIN_NUMS_pshufh_u,
  MIPS_BUILTIN_NUMS_pshufh_s,
  MIPS_BUILTIN_NUMS_psllh_u,
  MIPS_BUILTIN_NUMS_psllh_s,
  MIPS_BUILTIN_NUMS_psllw_u,
  MIPS_BUILTIN_NUMS_psllw_s,
  MIPS_BUILTIN_NUMS_psrah_u,
  MIPS_BUILTIN_NUMS_psrah_s,
  MIPS_BUILTIN_NUMS_psraw_u,
  MIPS_BUILTIN_NUMS_psraw_s,
  MIPS_BUILTIN_NUMS_psrlh_u,
  MIPS_BUILTIN_NUMS_psrlh_s,
  MIPS_BUILTIN_NUMS_psrlw_u,
  MIPS_BUILTIN_NUMS_psrlw_s,
  MIPS_BUILTIN_NUMS_psubw_u,
  MIPS_BUILTIN_NUMS_psubh_u,
  MIPS_BUILTIN_NUMS_psubb_u,
  MIPS_BUILTIN_NUMS_psubw_s,
  MIPS_BUILTIN_NUMS_psubh_s,
  MIPS_BUILTIN_NUMS_psubb_s,
  MIPS_BUILTIN_NUMS_psubd_u,
  MIPS_BUILTIN_NUMS_psubd_s,
  MIPS_BUILTIN_NUMS_psubsh,
  MIPS_BUILTIN_NUMS_psubsb,
  MIPS_BUILTIN_NUMS_psubush,
  MIPS_BUILTIN_NUMS_psubusb,
  MIPS_BUILTIN_NUMS_punpckhbh_u,
  MIPS_BUILTIN_NUMS_punpckhhw_u,
  MIPS_BUILTIN_NUMS_punpckhwd_u,
  MIPS_BUILTIN_NUMS_punpckhbh_s,
  MIPS_BUILTIN_NUMS_punpckhhw_s,
  MIPS_BUILTIN_NUMS_punpckhwd_s,
  MIPS_BUILTIN_NUMS_punpcklbh_u,
  MIPS_BUILTIN_NUMS_punpcklhw_u,
  MIPS_BUILTIN_NUMS_punpcklwd_u,
  MIPS_BUILTIN_NUMS_punpcklbh_s,
  MIPS_BUILTIN_NUMS_punpcklhw_s,
  MIPS_BUILTIN_NUMS_punpcklwd_s,

  MIPS_BUILTIN_NUMS_swap_acq,
  MIPS_BUILTIN_NUMS_swap_rel,
  MIPS_BUILTIN_NUMS_swapd_acq,
  MIPS_BUILTIN_NUMS_swapd_rel,

  MIPS_BUILTIN_NUMS_val_compare_and_swap_acq,
  MIPS_BUILTIN_NUMS_val_compare_and_swap_rel,
  MIPS_BUILTIN_NUMS_val_compare_and_swapd_acq,
  MIPS_BUILTIN_NUMS_val_compare_and_swapd_rel,
  MIPS_BUILTIN_NUMS_bool_compare_and_swap_acq,
  MIPS_BUILTIN_NUMS_bool_compare_and_swap_rel,
  MIPS_BUILTIN_NUMS_bool_compare_and_swapd_acq,
  MIPS_BUILTIN_NUMS_bool_compare_and_swapd_rel,

  MIPS_BUILTIN_NUMS_mips_thread_pointer,
  MIPS_BUILTIN_NUMS_thread_pointer,

  MIPS_BUILTIN_NUMS_cache,

  MIPS_BUILTIN_NUMS_mfc0,
  MIPS_BUILTIN_NUMS_mtc0,
  MIPS_BUILTIN_NUMS_mxc0,
  ...
  MIPS_BUILTIN_NUMS_software_breakpoints,
  MIPS_BUILTIN_NUMS_MAX
};

static GTY(()) tree mips_builtin_fndecls[(int) MIPS_BUILTIN_NUMS_MAX];
...
/* Return a type for 'volatile unsigned intSI'.  */

static tree
mips_build_vusi_type (void)
{
  static tree cache;
  if (cache == NULL_TREE)
    cache = build_qualified_type (unsigned_intSI_type_node,
                                 TYPE_QUAL_VOLATILE);
  return cache;
}
...
static tree
mips_build_vvoid_type (void)
{
  static tree cache;
  if (cache == NULL_TREE)
    cache = build_qualified_type (void_type_node,
                                 TYPE_QUAL_VOLATILE);
  return cache;
}
...
#define MIPS_ATYPE_VUSI mips_build_vusi_type ()
#define MIPS_ATYPE_VVOID mips_build_vvoid_type ()
...
/* Returns the mips builtin decl for CODE.  */
static tree
mips_builtin_decl (unsigned code, bool initialize_p ATTRIBUTE_UNUSED)
{
  if (code >= ARRAY_SIZE (mips_builtins))
    return error_mark_node;

  return mips_builtin_fndecls[code];
}
...
const char *
pic32_output_switch_ISAbase (void)
{
#define BUFSIZE 120
  ...
  if (TREE_CODE (argreg) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argreg) >
          (unsigned HOST_WIDE_INT) ((1 << 5) - 1))
        {
          ...
          opreg = mips_prepare_builtin_arg (icode, 1, exp, 0);
  ...
  if (TREE_CODE (argsel) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argsel) >
          (unsigned HOST_WIDE_INT) ((1 << 3) - 1))
        {
          ...
          opsel = mips_prepare_builtin_arg (icode, 2, exp, 1);
                   ...
                   tree exp)
{
  ...
  opval =  mips_prepare_builtin_arg (icode, 0, exp, 2);
                   ...
                   tree exp)
{
  ...
  if (TREE_CODE (argreg) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argreg) >
          (unsigned HOST_WIDE_INT) ((1 << 5) - 1))
        {
          warning (0, "argument 1 of `%s' not in the range 0 to %d.",
                   mips_builtins[fcode].name, (1 << 5) - 1);
          opreg = mips_prepare_builtin_arg (icode, 2, exp, 0);
          opreg = GEN_INT (INTVAL (opreg) & ((1 << 5) - 1));
        }
      else
        {
  ...
  if (TREE_CODE (argsel) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argsel) >
          (unsigned HOST_WIDE_INT) ((1 << 3) - 1))
        {
          warning (0, "argument 2 of `%s' not in the range 0 to %d.",
                   mips_builtins[fcode].name, (1 << 3) - 1);
          opsel = mips_prepare_builtin_arg (icode, 3, exp, 1);
          opsel = GEN_INT (INTVAL (opsel) & ((1 << 3) - 1));
        }
      else
        {
  ...
  opval =  mips_prepare_builtin_arg (icode, 1, exp, 2);
                    ...
                    tree exp)
{
  ...
  if (TREE_CODE (argreg) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argreg) >
          (unsigned HOST_WIDE_INT) ((1 << 5) - 1))
        {
          warning (0, "argument 1 of `%s' not in the range 0 to %d.",
                   mips_builtins[fcode].name, (1 << 5) - 1);
          opreg = mips_prepare_builtin_arg (icode, 3, exp, 0);
          opreg = GEN_INT (INTVAL (opreg) & ((1 << 5) - 1));
        }
      else
        {
  ...
  if (TREE_CODE (argsel) == INTEGER_CST)
    {
      if (TREE_INT_CST_LOW (argsel) >
          (unsigned HOST_WIDE_INT) ((1 << 3) - 1))
        {
          warning (0, "argument 2 of `%s' not in the range 0 to %d.",
                   mips_builtins[fcode].name, (1 << 3) - 1);
          opsel = mips_prepare_builtin_arg (icode, 4, exp, 1);
          opsel = GEN_INT (INTVAL (opsel) & ((1 << 3) - 1));
        }
      else
        {
  ...
  opclr =  mips_prepare_builtin_arg (icode, 0, exp, 2);
  opset =  mips_prepare_builtin_arg (icode, 1, exp, 3);
...
#ifdef MIPS_SUBTARGET_SET_CURRENT_FUNCTION
  MIPS_SUBTARGET_SET_CURRENT_FUNCTION(fndecl);
#endif
}

...
mips_rest_of_frame_header_opt (void)
{
  ...
  if ((skip_stack_frame_alloc && frame->total_size == 0)
	...
	{
	  element = (struct mips_frame_header_usage *)
	    GGC_NEW (struct mips_frame_header_usage);
