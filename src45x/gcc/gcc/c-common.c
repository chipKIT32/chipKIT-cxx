...
static tree handle_unique_section_attribute (tree *, tree, tree, int, bool *);
...
const struct attribute_spec c_common_attribute_table[] =
{
  ...
  { "unique_section",         0, 0, true,  false, false,
			      handle_unique_section_attribute },
                          ...
                          bool *no_add_attrs)
{
  ...
  if (targetm.have_named_sections)
    ...
    {
      error ("%Junique_section attributes are not supported for this target", *node);
      *no_add_attrs = true;
    }
