...
[0-9a-f]+ <[^>]*> lw	a1,-23127\(at\)
[0-9a-f]+ <[^>]*> lui	at,0x0
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_HI16|REFHI)	(data_label|\.data(-0x1000)?)
[0-9a-f]+ <[^>]*> lw	a0,(0|4096)\(at\)
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_LO16|REFLO)	(data_label|\.data(-0x1000)?)
...
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_GPREL16|GPREL)	small_external_common
[0-9a-f]+ <[^>]*> lui	at,0x0
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_HI16|REFHI)	(big_local_common|\.bss(-0x2000)?)
[0-9a-f]+ <[^>]*> lw	a0,(0|8192)\(at\)
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_LO16|REFLO)	(big_local_common|\.bss(-0x2000)?)
...
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_LO16|REFLO)	(big_local_common|\.bss(-0x2000)?)
[0-9a-f]+ <[^>]*> lui	at,0x1
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_HI16|REFHI)	(small_local_common|\.sbss(-0x1000)?)
[0-9a-f]+ <[^>]*> lw	a0,-(32768|28672)\(at\)
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_LO16|REFLO)	(small_local_common|\.sbss(-0x1000)?)
[0-9a-f]+ <[^>]*> lw	a1,-(32764|28668)\(at\)
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_LO16|REFLO)	(small_local_common|\.sbss(-0x1000)?)
[0-9a-f]+ <[^>]*> lui	at,0x0
[ 	]*[0-9a-f]+: (R_(MICRO)?MIPS_HI16|REFHI)	(data_label|\.data(-0x1000)?)
