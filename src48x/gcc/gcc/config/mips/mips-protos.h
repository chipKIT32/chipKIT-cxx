...
extern void mips_save_reg (rtx reg, rtx mem);
extern rtx mips16e_build_save_restore (bool restore_p, unsigned int *mask_ptr,
...
extern const char* pic32_output_mxc0_32 (rtx target, rtx value, int srcreg, int srcsel);
extern const char* pic32_output_bcc0_32 ( rtx target, rtx tmp, int regval, int sel);
extern const char* pic32_output_bsc0_32 ( rtx target, rtx tmp, int regval, int sel);
extern const char* pic32_output_bcsc0_32 (rtx target, int opclr, int opset, rtx opreg, rtx opsel);
extern const char* pic32_output_ei(rtx);
extern const char* pic32_output_di(rtx);
