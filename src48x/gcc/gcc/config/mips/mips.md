...
;; Used for PIC32
   ...
   (UNSPECV_SWITCH_ISA32    807)
   (UNSPECV_SWITCH_ISA16    808)

   (UNSPECV_UNIQUEID        809) ; '__builtin_unique_id' instruction
   (UNSPECV_GENLABEL32      810)
   (UNSPECV_GENLABEL16      811)
   (UNSPECV_ITTYPE          812)
   (UNSPEC_SECTION_BEGIN    813)
   (UNSPEC_SECTION_BEGIN_16   814)
   (UNSPEC_SECTION_END        815)
   (UNSPEC_SECTION_SIZE       816)
   (UNSPECV_SET_INTERRUPT_STATE16  817)
   (UNSPECV_GET_INTERRUPT_STATE16  818)
   (UNSPECV_DISABLE_INTERRUPTS     819)
   (UNSPECV_ENABLE_INTERRUPTS      820)
...
(define_insn "pic32_ei"
  ...
  ""
  {
    pic32_output_ei (operands[0]);
  }
  [(set_attr "type"     "trap")
   (set_attr "mode"     "none")])

(define_insn "pic32_sdbbp0"
  [(unspec_volatile [(const_int 0)] UNSPECV_SOFTWARE_BREAKPOINT)]
  ""
  "%(sdbbp 0%)"
  [(set_attr "type"     "trap")
   (set_attr "mode"     "none")])
...
;; Write to GPR in previous shadow register set.
(define_insn "mips_wrpgpr"
  [(set (match_operand:SI 0 "register_operand" "=d")
        (unspec_volatile:SI [(match_operand:SI 1 "register_operand" "d")]
                            UNSPEC_WRPGPR))]
  ""
  ...
  [
    (unspec_volatile:SI [(match_operand:SI 0 "register_operand" "d")
                      (match_operand:SI 1 "register_operand" "+d")]
                            UNSPECV_GET_ISR_STATE)
  (clobber (reg:SI 31))]
  ""
{
  return pic32_output_get_isr_state_mips16 (operands[0],
                              operands[1]);
}
  [(set_attr "type"     "mfc")
   (set_attr "mode"     "none")
...
(define_insn "set_isr_state_mips16"
  [
    (unspec_volatile:SI [(match_operand:SI 0 "register_operand" "d")
                         (match_operand:SI 1 "register_operand" "+d")
                         (match_operand:SI 2 "register_operand" "d")]
  ...
  ""
{
  return pic32_output_set_isr_state_mips16
                                  (operands[0],
                                   operands[1], 
                                   operands[2]);
}
...
(define_insn "pic32_switch_isabase16"
  [(unspec_volatile [(const_int 0)] UNSPECV_SWITCH_ISA16)
   (clobber (reg:SI 31))]
  "TARGET_MIPS16"
  {
     return pic32_output_switch_ISA16();
  }
  [(set_attr "type"     "jump")
   (set_attr "mode"     "none")
   (set_attr "length"   "0")])

(define_insn "pic32_switch_isabase32"
  [(unspec_volatile [(const_int 0)] UNSPECV_SWITCH_ISA32)
   (clobber (reg:SI 31))]
  "TARGET_MIPS16"
  {
     return pic32_output_switch_ISA32();
  }
  [(set_attr "type"     "jump")
   (set_attr "mode"     "none")
   (set_attr "length"   "0")])
...
;; Move involving COP0 registers.
(define_insn "pic32_mfc0"
  [(set (match_operand:SI 0 "register_operand" "=d")
   (unspec_volatile:SI [(match_operand:SI 1 "immediate_operand" "JK")
                     (match_operand:SI 2 "immediate_operand" "JK")]
                            UNSPECV_MFC0_32))
   (clobber (reg:SI 31))]
  ""
{
  return pic32_output_mfc0_32 (operands[0],
                              INTVAL(operands[1]),
                              INTVAL(operands[2]));
}
  [(set_attr "type"     "mfc")
...
;; MXC0
(define_insn "pic32_mxc0"
  [(set (match_operand:SI 0 "register_operand" "=&d")
   (unspec_volatile [(match_operand:SI 1 "register_operand" "d")
                     (match_operand:SI 2 "immediate_operand" "JK")
                     (match_operand:SI 3 "immediate_operand" "JK")]
                            UNSPECV_MXC0_32))
   (clobber (reg:SI 31))]
  ""
{ return pic32_output_mxc0_32 (
                              operands[0],
                              operands[1],
                              INTVAL(operands[2]),
                              INTVAL(operands[3]));
...
(define_insn "pic32_bcc0"
  ...
  (clobber (reg:SI 31))]
  ""
{ return  pic32_output_bcc0_32( operands[0],
                              operands[1],
                              INTVAL(operands[2]),
                              INTVAL(operands[3]) );
}
...
(define_insn "pic32_bsc0"
  ...
  (clobber (reg:SI 31))]
  ""
{ return    pic32_output_bsc0_32( operands[0],
                              operands[1],
                              INTVAL(operands[2]),
                              INTVAL(operands[3]) );
}
...
;; BCSC0
(define_insn "pic32_bcsc0"
  [(set (match_operand:SI 0 "register_operand" "=&d")
   (unspec_volatile [(match_operand:SI 1 "register_operand" "+d")
                     (match_operand:SI 2 "register_operand" "d")
                     (match_operand:SI 3 "immediate_operand" "JK")
                     (match_operand:SI 4 "immediate_operand" "JK")]
                            UNSPECV_BCSC0_32))
   (clobber (reg:SI 31))]
  ""
{ return  pic32_output_bcsc0_32( operands[0],
                                 INTVAL(operands[1]),
                                 INTVAL(operands[2]),
                                 operands[3],
                                 operands[4]);
