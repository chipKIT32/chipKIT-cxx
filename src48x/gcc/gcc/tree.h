...
struct GTY(()) tree_decl_common {
  ...
  unsigned unique_section_flag : 1;
...
/* Indicates that the decl should be placed in a unique section. If
   a "section" attribute is present, that section name will be used as
   the base name for the section (in place of .text, .data, et. al) */
#define DECL_UNIQUE_SECTION(NODE) (DECL_COMMON_CHECK (NODE)->decl_common.unique_section_flag)
