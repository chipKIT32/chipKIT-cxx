...
main (void)
{
  ...
  /* c[hi] = a[hi], c[lo] = b[hi]  */
  c = __ev_mergehi (a, b);
  if (c[0] != (BIG_ENDIAN ? 0x11111111 : 0x44444444))
    abort ();
  if (c[1] != (BIG_ENDIAN ? 0x33333333 : 0x22222222))
    abort ();
  /* c[hi] = a[lo], c[lo] = b[lo]  */
  c = __ev_mergelo (a, b);
  if (c[0] != (BIG_ENDIAN ? 0x22222222 : 0x33333333))
    abort ();
  if (c[1] != (BIG_ENDIAN ? 0x44444444 : 0x11111111))
    abort ();
  /* c[hi] = a[lo], c[lo] = b[hi]  */
  c = __ev_mergelohi (a, b);
  if (c[0] != (BIG_ENDIAN ? 0x22222222 : 0x44444444))
    abort ();
  if (c[1] != (BIG_ENDIAN ? 0x33333333 : 0x11111111))
    abort ();
  /* c[hi] = a[hi], c[lo] = b[lo]  */
  c = __ev_mergehilo (a, b);
  if (c[0] != (BIG_ENDIAN ? 0x11111111 : 0x33333333))
    abort ();
  if (c[1] != (BIG_ENDIAN ? 0x44444444 : 0x22222222))
    abort ();
